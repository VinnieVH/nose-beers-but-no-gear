...
export const fetchGuildInfo = async (
  ...
  return await api.fetchGuild(guildName, serverSlug, serverRegion)
}
...
export const fetchGuildMembers = async (
  ...
  const serverSlug = getServerSlug(serverName)
  return await api.fetchGuildMembers(guildName, serverSlug, serverRegion)
}
...
export const fetchGuildLogs = async (
  ...
  const serverSlug = getServerSlug(serverName)
  return await api.fetchGuildReports(guildName, serverSlug, serverRegion)
}
